...
from pinnacle.base.leaf import imported_value
...
from pinnacle.components.model import ImportedModel, Model, ObjectModel, Trainer
...
ibis_config = os.environ.get('pinnacle_CONFIG', "").endswith('ibis.yaml')
mongodb_config = os.environ.get('pinnacle_CONFIG', "").endswith('mongodb.yaml')
