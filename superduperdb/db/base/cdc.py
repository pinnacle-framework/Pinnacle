...
from pinnacledb.vector_search.vector_task_factory import vector_task_factory

if t.TYPE_CHECKING:
    from pinnacledb.container.serializable import Serializable
    from pinnacledb.db.base.db import DB
    from pinnacledb.db.base.query import TableOrCollection
...
class BaseDatabaseListener(ABC):
    ...
    def __init__(
        ...
        from pinnacledb.db.base import backends
        from pinnacledb.db.mongodb.cdc.base import MongoDBPacket
...
class DatabaseListenerFactory(t.Generic[DBListenerType]):
    ...
    def create(self, *args, **kwargs) -> DBListenerType:
        ...
        if self.db_type == 'mongodb':
            from pinnacledb.db.mongodb.cdc.listener import MongoDatabaseListener
...
class DatabaseChangeDataCapture:
    ...
    def listen(
        ...
        **kwargs,
        ...
        Not to be confused with ``pinnacledb.container.listener.Listener``.
