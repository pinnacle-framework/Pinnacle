...
from pinnacledb.backends.ibis import query
from pinnacledb.backends.ibis.cdc.base import IbisDBPacket
from pinnacledb.base.config import LogBasedStrategy, PollingStrategy
        ...
        :param strategy: Used to select strategy used for listening changes
                        options:
                            PollingStrategy (This strategy polls table every
                                            ...
                                            pinnacledb.cdc.cdc.PollingStrategy)
