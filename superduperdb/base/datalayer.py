...
from pinnacledb.components.datatype import DataType, Encodable, serializers
...
from pinnacledb.misc.download import download_content, download_from_one
...
class Datalayer:
    ...
    def rebuild(self, cfg=None):
        from pinnacledb.base import build
    ...
    def add(
        ...
        if isinstance(object, (list, tuple)):
            ...
            return self._add(pinnacle(object)), object
