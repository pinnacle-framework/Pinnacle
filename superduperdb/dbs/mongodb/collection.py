...
from pinnacledb.dbs.mongodb.cursor import SuperDuperCursor
...
from pinnacledb.fetchers.web.downloads import gather_urls, InMemoryDownloader
from pinnacledb.models.torch.wrapper import apply_model


class Collection(MongoCollection):
    """
    Collection building on top of ``pymongo.collection.Collection``.
    Implements additional methods required by ``pinnacledb`` for AI/ machine learning.
    """
