...
from pinnacledb.components.model import ObjectModel, SequentialModel, CodeModel
...
# from pinnacledb.ext.vllm.model import VllmAPI
...
def build_app(app: pinnacleapp.SuperDuperApp):
    ...
    def spec_lookup():
        ...
        #     {
        #         "model": {
        #             "ObjectModel": "pinnacledb.components.model"
        #         },
        #         "datatype": {
        #             "array": "pinnacledb.ext.numpy.encoder"
        #         }
        #     }
    ...
    def db_apply(info: t.Dict):
        ...
        #         "stack/test_stack/0": {
        #           "cls": "Stack",
        #           "module": "pinnacledb.components.stack",
        #           "dict": {
        ...
        #           "cls": "DataType",
        #           "module": "pinnacledb.components.datatype",
        #           "dict": {
