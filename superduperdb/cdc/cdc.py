...
class DatabaseListenerFactory(t.Generic[DBListenerType]):
    ...
    def create(self, *args, **kwargs) -> DBListenerType:
        ...
        if self.db_type == 'mongodb':
            from pinnacledb.backends.mongodb.cdc.listener import MongoDatabaseListener
            ...
            from pinnacledb.backends.ibis.cdc.listener import IbisDatabaseListener
...
class DatabaseChangeDataCapture:
    ...
    :param db: A pinnacledb datalayer instance.
    """
    ...
    def listen(
        ...
        **kwargs,
        ...
        """
        from pinnacledb.backends.base import backends
