...
# base classes and interfaces in ``pinnacledb.vector_search.base``.
...
class LanceVectorDatabase(VectorDatabase):
    ...
    # of the interface in ``pinnacledb/container/vector_index.py``! Short-term fix
...
class LanceVectorCollection(VectorCollection):
    ...
    # of the interface in ``pinnacledb/db/mongodb/cdc/vector_task_factory.py``!
