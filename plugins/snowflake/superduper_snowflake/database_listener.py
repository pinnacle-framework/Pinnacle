...
from pinnacle.backends.base.cdc import BaseDatabaseListener, DBEvent
from pinnacle.misc.threading import Event
...
class SnowflakeDatabaseListener(BaseDatabaseListener):
    ...
    def setup_cdc(self) -> _SnowflakeCDCChangeStream:
        ...
        if uri == "snowflake://":
            ...
            schema = os.environ["pinnacle_DATA_SCHEMA"]
