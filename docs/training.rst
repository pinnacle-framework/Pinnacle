...
The first way uses ``pinnacledb.collection.Collection.create_semantic_index``
and the second way uses ``pinnacledb.collection.Collection.create_imputation``.
...
.. code-block:: python
    ...
    >>> pinnacledb.client import SuperDuperClient
