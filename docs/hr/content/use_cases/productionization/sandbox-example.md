...
To set up this environment, navigate to your local copy of the `pinnacledb` repository, edit the `requirements.txt` to look like this:
...
```bash
make testenv_init pinnacleDB_DATA=sandbox
```
