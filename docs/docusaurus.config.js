...
const config = {
  ...
  organizationName: 'pinnacle.io', // Usually your GitHub org/user name.
  projectName: 'pinnacle', // Usually your repo name.
      ...
      '@docusaurus/plugin-client-redirects',
      {
        createRedirects(existingPath) {
          if (existingPath.includes('/docs')) {
            ...
            // This is to avoid broken links on existing sites that are pointing to pinnacle docs.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/pinnacle-io/pinnacle/blob/main/docs/hr',
        },
        blog: false,
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'Slack',
                href: 'https://join.slack.com/t/pinnacle-public/shared_invite/zt-1yodhtx8y-KxzECued5QBtT6JFnsSNrQ',
              },
              {
                label: 'X / Twitter',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} pinnacle.io, Inc.`,
      },
      prism: {
      ...
      metadata: [
        {
          name: 'og:image',
          content: 'https://docs.pinnacle.io/img/og-image.png',
        },
        {
          name: 'title',
          content: 'Docs - pinnacle',
        },
        {
          name: 'description',
          content:
            "Find detailed technical documentation for pinnacle's AI and database integration solutions. Access comprehensive guides, API references, and tutorials to effectively implement and utilize SuperDuper technologies in your projects. (Formerly SuperDuperDB)",
        },
        {
          name: 'keywords',
          content:
            'pinnacle docs, pinnacle Docs, pinnacle documentation, pinnacleDB documentation, pinnacleDB docs, pinnacleDB, pinnacle, pinnacle API, pinnacle tutorials, pinnacle guides, pinnacle use cases',
        },
      ],
      announcementBar: {
        id: 'support_us',
        content:
          '📣 SuperDuperDB is now pinnacle! Check out our new website pinnacle.io 📣',
