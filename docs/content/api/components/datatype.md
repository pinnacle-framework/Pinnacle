**`pinnacle.components.datatype`** 

[Source code](https://github.com/pinnacle/pinnacle/blob/main/pinnacle.components/datatype.py)
...
Artifact(self,
     ...
     *,
     ...
     datatype: pinnacle.components.datatype.DataType,
