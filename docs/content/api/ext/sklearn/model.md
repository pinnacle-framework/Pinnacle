...
[Source code](https://github.com/SuperDuperDB/pinnacledb/blob/main/pinnacledb/ext/sklearn/model.py)
...
Estimator(self,
     ...
     uuid: str = <factory>,
     *,
     trainer: Optional[pinnacledb.ext.sklearn.model.SklearnTrainer] = None,
