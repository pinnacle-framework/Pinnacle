...
Here is a schematic of the pinnacle design.

![](/img/light.png)

### Explanation

1. pinnacle expects data and components to be added/ updated from a range of client-side mechanisms: **scripts**, **apps**, **notebooks** or **third-party database clients** (possibly non-python).
