...
- **[特征存储](https://docs.pinnacledb.com/docs/docs/mongodb_query_API#inserts)：** 将您的数据库转变为可用于存储和管理AI模型中任意数据类型的数据输入和输出的中心化存储库，使各种数据可以在熟悉的环境中易结构化的格式来使用。
...
立即尝试我们的 Jupyter Notebook [直接在您的浏览器上体验](https://demo.pinnacledb.com)。

同时，您还可以在 [pinnacle-community-apps 仓库](https://github.com/SuperDuperDB/pinnacle-community-apps) 中找到由社区构建的用例和应用。
...
<table>
  ...
  <tr>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/multimodal_image_search_clip.ipynb">图像搜索</a>
    </th>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/video_search.ipynb">视频搜索</a>
    </th>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/question_the_docs.ipynb">文档问答</a>
    </th>
  </tr>
  <tr>     
    <td width="30%">
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/vector_search.ipynb">
    ...
    <td width="30%">
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/mnist_torch.ipynb">
    ...
    <td width="30%">
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/transfer_learning.ipynb">
  ...
  <tr>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/vector_search.ipynb">语义搜索引擎</a>
    </th>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/mnist_torch.ipynb">标准机器学习</a>
    </th>
    <th>
      <a href="https://demo.pinnacledb.com/user-redirect/lab/tree/examples/transfer_learning.ipynb">跨框架迁移学习</a>
    </th>
  </tr>
</table>
