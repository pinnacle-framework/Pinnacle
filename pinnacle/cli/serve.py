...
def local_cluster(
    ...
    """
    from pinnacle.server.cluster import attach_cluster, down_cluster, up_cluster
...
def vector_search():
    ...
    from pinnacle.vector_search.server.app import app
...
def scheduler():
    ...
    from pinnacle.server.scheduler import app
...
def cdc():
    ...
    from pinnacle.cdc.app import app
...
def crontab():
    ...
    from pinnacle.crontab.service import app
...
def ray_serve(
    ...
    """
    from pinnacle.backends.ray.serve import run
...
def rest():
    ...
    from pinnacle.rest.app import app
