...
from pinnacle.components.datatype import DataType, dill_lazy
...
class Model(Component, metaclass=ModelMeta):
    ...
    def _eager_call__(self, *args, **kwargs):
        from pinnacle.misc.eager import SuperDuperData, SuperDuperDataType, TrackData
