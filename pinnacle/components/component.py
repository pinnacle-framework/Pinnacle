"""The component module provides the base class for all components in pinnacle.io."""
...
class ComponentMeta(BaseMeta):
    ...
    def __new__(cls, name, bases, dct):
        ...
        pinnacled_metadata_fields = {}
        for base in bases:
            if hasattr(base, 'metadata_fields'):
                pinnacled_metadata_fields.update(base.metadata_fields)
        new_cls.metadata_fields = {**new_cls.metadata_fields, **pinnacled_metadata_fields}
...
class Component(Base, metaclass=ComponentMeta):
    """Base class for all components in pinnacle.io.

    Class to represent pinnacle.io serializable entities
    ...
    def get_children_refs(self, deep: bool = False, only_initializing: bool = False):
        ...
        def _find_refs(r):
            ...
            from pinnacle.base.datatype import ComponentRef
    ...
    def get_children(self, deep: bool = False) -> t.List["Component"]:
        ...
        """
        from pinnacle.base.datatype import ComponentRef, Saveable
    ...
    def setup(self):
        ...
        def _setup(item):
            ...
            if 'pinnacle.components.component.Component' in mro(item):
                item.setup()
                return item
            ...
            from pinnacle.base.datatype import Saveable, ComponentRef
