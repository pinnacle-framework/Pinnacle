...
from pinnacle.backends.base.queue import JobFutureException
from pinnacle.base.constant import KEY_BLOBS, KEY_FILES
from pinnacle.base.event import EventType
from pinnacle.base.leaf import Leaf, LeafMeta
...
class Component(Leaf, metaclass=ComponentMeta):
    ...
    def read(path: str, db: t.Optional[Datalayer] = None):
        ...
        if db is not None:
            ...
            def load_blob(blob, loader=None):
                from pinnacle.misc.hash import hash_string
    ...
    def dict(self, metadata: bool = True, defaults: bool = True) -> 'Document':
        ...
        from pinnacle import Document
        from pinnacle.components.datatype import Artifact, File
    ...
    def info(self, verbosity: int = 1):
        ...
        """
        from pinnacle.misc.special_dicts import _display_component
