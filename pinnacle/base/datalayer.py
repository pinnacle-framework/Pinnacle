...
from pinnacle.base.datatype import BaseType, ComponentType
...
class Datalayer:
    ...
    def insert(self, items: t.List[Base]):
        ...
        :param items: The instances (`pinnacle.base.Base`) to insert.
        """
    ...
    def replace(self, condition: t.Dict, item: Base):
        ...
        :param item: The instances (`pinnacle.base.Base`) to insert.
        """
    ...
    def on_event(self, table: str, ids: t.List[str], event_type: 'str'):
        ...
        """
        from pinnacle.base.event import Change
