"""Configuration variables for pinnacle.io.

The classes in this file define the configuration variables for pinnacle.io,
...
class QueueConfig(BaseConfig):
    ...
    uri: t.Optional[str] = None  # None implies local mode
    _path: t.Optional[str] = 'pinnacle.jobs.queue.LocalQueuePublisher'
...
class Compute(BaseConfig):
    ...
    _path: t.Optional[str] = 'pinnacle.backends.local.compute.LocalComputeBackend'
...
class Config(BaseConfig):
    ...
    :param lance_home: The home directory for the Lance vector indices,
                       Default: .pinnacle/vector_indices
    ...
    lance_home: str = os.path.join('.pinnacle', 'vector_indices')
