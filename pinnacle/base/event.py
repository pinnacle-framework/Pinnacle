...
class DeploymentPlan:
    ...
    def show(self, style=True):
        ...
        pinnacled_tree = Tree('DEPLOYMENT PLAN')
        pinnacled_tree.add(create_tree)
        pinnacled_tree.add(job_tree)

        console = Console()
        console.print(pinnacled_tree)
...
class Job(Event):
    ...
    def get_args_kwargs(self, futures):
        from pinnacle.backends.base.queue import Future
