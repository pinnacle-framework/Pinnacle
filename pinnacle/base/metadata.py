...
from pinnacle.base.status import JOB_PHASE_UNINITIALIZED, JOB_PHASE_PENDING, JOB_PHASE_RUNNING, JOB_PHASE_FAILED, \
    JOB_PHASE_SUCCESS
...
class Job(Base):
    ...
    def get_args_kwargs(self, futures):
        ...
        """
        from pinnacle.backends.base.scheduler import Future
...
class MetaDataStore:
    ...
    def init(self):
        ...
        if r is None:
            r = Table(
                ...
                primary_id='uuid',
                is_component=True,
                path='pinnacle.components.table.Table',
            ).encode()
            r['version'] = 0
    ...
    def set_job_status(self, job_id: str, status_update: t.Dict):
        ...
        status = pinnacle_dicts(job['status'], status_update)
    ...
    def set_component_status(self, component: str, uuid: str, status_update: t.Dict):
        ...
        status = pinnacle_dicts(r['status'], status_update)
