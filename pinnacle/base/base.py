...
from pinnacle.misc.annotations import (
    extract_parameters,
    lazy_classproperty,
    replace_parameters,
)
from pinnacle.misc.serialization import asdict
...
class BaseMeta(type):
    ...
    def __new__(mcs, name, bases, namespace):
        ...
        is_base = namespace.get('__module__', '') == 'pinnacle.base.base' and name == 'Base'
        is_component = namespace.get('__module__', '') == 'pinnacle.components.component' and name == 'Component'
...
class Base(metaclass=BaseMeta):
    """Base class for all pinnacle classes."""
    ...
    def variables(self) -> t.List[str]:
        ...
        from pinnacle.base.variables import _find_variables
    ...
    def dict(
        ...
        from pinnacle.components.datatype import DEFAULT_SERIALIZER
