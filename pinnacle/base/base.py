...
class BaseMeta(type):
    ...
    def __new__(mcs, name, bases, namespace):
        ...
        is_base = (
            namespace.get('__module__', '') == 'pinnacle.base.base' and name == 'Base'
        )
        is_component = (
            namespace.get('__module__', '') == 'pinnacle.components.component'
            and name == 'Component'
        )
...
class Base(metaclass=BaseMeta):
    ...
    def source_code(cls):
        ...
        try:
            ...
            from pinnacle.misc.utils import grab_source_code_ipython
