...
from pinnacle.misc.annotations import extract_parameters, replace_parameters
...
class Leaf(metaclass=LeafMeta):
    ...
    def encode(self, leaves_to_keep=(), metadata: bool = True, defaults: bool = True):
        ...
        """
        from pinnacle.base.document import _deep_flat_encode
    ...
    def dict(self, metadata: bool = True, defaults: bool = True):
        ...
        from pinnacle.components.datatype import Artifact, dill_serializer
