...
from pinnacle.backends.base.backends import data_backends, metadata_stores
from pinnacle.backends.base.data_backend import BaseDataBackend, DataBackendProxy
...
def build_compute(cfg):
    ...
    path = compute._path or 'pinnacle.backends.local.compute.LocalComputeBackend'
    queue_path = queue._path or 'pinnacle.jobs.queue.LocalSequentialQueue'
...
def build_datalayer(cfg=None, databackend=None, **kwargs) -> Datalayer:
    ...
    :param cfg: Configuration to use. If None, use ``pinnacle.CFG``.
    :param databackend: Databacked to use.
                        If None, use ``pinnacle.CFG.data_backend``.
