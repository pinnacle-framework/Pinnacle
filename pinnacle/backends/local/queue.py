...
from pinnacle.backends.base.queue import consume_apply_event, consume_streaming_events
from pinnacle.base.event import Event
from pinnacle.backends.base.queue import BaseQueueConsumer, BaseQueuePublisher
...
class LocalQueuePublisher(BaseQueuePublisher):
    ...
    def _put(self, component):
        msg = 'Table name "_apply" collides with pinnacle namespace'
